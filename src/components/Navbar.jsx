    ...
    <div className="fixed w-full z-10 bg-opacity-30 bg-slate-950">
      <div className="flex justify-center w-lvh">
        <ul className="flex gap-6 md:gap-8 bg-slate-800 rounded-b-2xl p-4 ">
          ...
          <li><a href=" https://drive.google.com/file/d/1IW5P_CC2-FeWOGv_NgBsup7_3AphHVJM/view?usp=sharing"><button className="hover:bg-slate-600 rounded-2xl md:p-2 md:m-2 hover:border-blue-500 hover:border-2 hover:shadow-lg hover:shadow-blue-500">Resume</button></a></li>
        </ul>
      </div>
      <div className="absolute top-0 right-0 flex gap-2">
        <LinkImg link="https://codeforces.com/profile/forcerounit" imgPath="./img/icons8-codeforces-96.png" />
        <LinkImg link="https://www.linkedin.com/in/rounit-kashyap/" imgPath="./img/icons8-linkedin.svg" />
        <LinkImg link="https://github.com/Rounit-1st" imgPath="./Hyper_Image/github.png" />
      </div>
    </div>
  )
}
